...
class TopRatedAdapter(
    private val topRatedListener: TopRatedListener
) : PagingDataAdapter<Movie, TopRatedAdapter.MovieViewHolder>(MOVIE_DIFF_UTIL) {
        ...
        init {
            itemView.setOnClickListener {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    if (item != null) {
                        topRatedListener.onTopRatedMovieClicked(item, position)
                    }
                }
            }
        }
    ...
    interface TopRatedListener {
        fun onTopRatedMovieClicked(movie: Movie, position: Int)
    }
